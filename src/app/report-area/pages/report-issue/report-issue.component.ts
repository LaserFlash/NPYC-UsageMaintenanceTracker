...
import { Levels, PartsRiB } from "../../../core/constants/menu-names/menuNames";
...
export class ReportIssueComponent implements OnInit {
  ...
  private onValueChanged(data?: any) {
    this.breakage[0] = new BreakageInfo(
      ...
      this.breakageForm
        ...
        .get([1])
        .get("boatID").value,
      ImportanceConversionHelper.numberFromImportance(
        this.breakageForm
          .get("formArray")
          .get([1])
  ...
  public onSubmit() {
    if (this.breakageForm.valid) {
      ...
      this.breakageService
        .addBreakageInfo(breakage)
        .then(
          () => (
